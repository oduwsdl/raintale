...
if __name__ == '__main__':
    print("Video stories are not yet supported by the Raintale GUI. Please be patient. This functionality will be available soon. If you need video stories, please consult the Raintale CLI at https://raintale.readthedocs.io/en/latest/")
