...
parser = argparse.ArgumentParser(prog="{}".format(sys.argv[0]),
    description='Given a list of story elements, including URLs to archived web pages, create a Facebook post and comments summarizing the list.',
...
if __name__ == '__main__':
    print("Facebook stories are not yet supported by the Raintale GUI. Please be patient. This functionality will be available soon. If you need Facebook stories, please consult the Raintale CLI at https://raintale.readthedocs.io/en/latest/")
