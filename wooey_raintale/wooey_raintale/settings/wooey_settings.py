...
if DJANGO_VERSION < DJ110:
    ...
    MIDDLEWARE_CLASSES.append('wooey_raintale.middleware.ProcessExceptionMiddleware')
    MIDDLEWARE_OBJ = MIDDLEWARE_CLASSES
else:
    # Using Django 1.10 +
    MIDDLEWARE = list(MIDDLEWARE)
    MIDDLEWARE.append('wooey_raintale.middleware.ProcessExceptionMiddleware')
...
NEW_MIDDLEWARE.append('wooey_raintale.middleware.ProcessExceptionMiddleware')
if DJANGO_VERSION < DJ110:
    MIDDLEWARE_CLASSES = NEW_MIDDLEWARE
else:
    MIDDLEWARE = NEW_MIDDLEWARE

PROJECT_NAME = "wooey_raintale"
